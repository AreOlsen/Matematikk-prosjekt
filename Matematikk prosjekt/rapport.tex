...
\begin{figure}[H]
    \centering
    \fbox{
        \includegraphics[scale=0.4]{Bileter/Datasettet.png}
    }
...
\begin{figure}[H]
    \centering
    \fbox{
        \includegraphics[scale=0.4]{Bileter/MultiVariabel.png}
    }
